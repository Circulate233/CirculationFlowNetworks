...
public final class MachinePriorityPackets {
    ...
    public static final class Submit implements Packet<Submit> {
        public static final Type<Submit> TYPE = new Type<>(
            Identifier.parse(CirculationFlowNetworks.MOD_ID + ":submit_machine_priority")
        );
        ...
        @Override
        public @NotNull Submit decode(@NotNull RegistryFriendlyByteBuf buf) {
        ...
        @Override
        public void handle(@NotNull Submit message, @NotNull IPayloadContext context) {
