...
public final class GridParticipantIndex {
    ...
    private static final class MachineInteractionReadView
        extends AbstractMap<Long, EnergyMachineManager.Interaction>
        implements Long2ObjectMap<EnergyMachineManager.Interaction> {
        ...
        @Override
        public EnergyMachineManager.Interaction get(Object key) {
            return source.get(key);
        }
        ...
        @Override
        public @NotNull ObjectSet<Map.Entry<Long, EnergyMachineManager.Interaction>> entrySet() {
        ...
        @Override
        public EnergyMachineManager.Interaction remove(Object key) {
            throw readOnlyMutation();
        }
        ...
        @Override
        public void putAll(@NotNull Map<? extends Long, ? extends EnergyMachineManager.Interaction> mappings) {
            throw readOnlyMutation();
        }
        ...
        @Override
        public EnergyMachineManager.Interaction putIfAbsent(Long key, EnergyMachineManager.Interaction value) {
            throw readOnlyMutation();
        }
        ...
        public boolean replace(Long key,
                               EnergyMachineManager.Interaction oldValue,
                               EnergyMachineManager.Interaction newValue) {
            throw readOnlyMutation();
        }

        @Override
        public EnergyMachineManager.Interaction replace(Long key, EnergyMachineManager.Interaction value) {
            throw readOnlyMutation();
        }

        @Override
        public void replaceAll(@NotNull BiFunction<? super Long, ? super EnergyMachineManager.Interaction,
            ? extends EnergyMachineManager.Interaction> function) {
            throw readOnlyMutation();
        }

        @Override
        public EnergyMachineManager.Interaction computeIfAbsent(
            Long key,
            @NotNull Function<? super Long, ? extends EnergyMachineManager.Interaction> mappingFunction) {
            throw readOnlyMutation();
        }

        @Override
        public EnergyMachineManager.Interaction computeIfPresent(
            Long key,
            @NotNull BiFunction<? super Long, ? super EnergyMachineManager.Interaction,
                ? extends EnergyMachineManager.Interaction> remappingFunction) {
            throw readOnlyMutation();
        }

        @Override
        public EnergyMachineManager.Interaction compute(
            Long key,
            @NotNull BiFunction<? super Long, ? super EnergyMachineManager.Interaction,
                ? extends EnergyMachineManager.Interaction> remappingFunction) {
            throw readOnlyMutation();
        ...
        @Override
        public EnergyMachineManager.Interaction merge(
            Long key,
            @NotNull EnergyMachineManager.Interaction value,
            @NotNull BiFunction<? super EnergyMachineManager.Interaction, ? super EnergyMachineManager.Interaction,
                ? extends EnergyMachineManager.Interaction> remappingFunction) {
            throw readOnlyMutation();
        }
    ...
    private static final class ReadOnlyBoxedEntryIterator
        extends AbstractObjectIterator<Map.Entry<Long, EnergyMachineManager.Interaction>> {

        private final ObjectIterator<Long2ObjectMap.Entry<EnergyMachineManager.Interaction>> delegate;

        private ReadOnlyBoxedEntryIterator(
            ObjectIterator<Long2ObjectMap.Entry<EnergyMachineManager.Interaction>> delegate) {
            this.delegate = delegate;
        }
        ...
        @Override
        public @NotNull Map.Entry<Long, EnergyMachineManager.Interaction> next() {
            Long2ObjectMap.Entry<EnergyMachineManager.Interaction> entry = delegate.next();
            return new ImmutableMachineInteractionEntry(entry.getLongKey(), entry.getValue());
        }
    ...
    private static class ReadOnlyBoxedEntrySet
        ...
        @Override
        public @NotNull ObjectIterator<Map.Entry<Long, EnergyMachineManager.Interaction>> iterator() {
            return new ReadOnlyBoxedEntryIterator(source.long2ObjectEntrySet().iterator());
        }
        ...
        @Override
        public boolean addAll(
            @NotNull Collection<? extends Map.Entry<Long, EnergyMachineManager.Interaction>> entries) {
            throw new UnsupportedOperationException("Machine interaction view is read-only");
        }
        ...
        @Override
        public boolean removeIf(
            @NotNull Predicate<? super Map.Entry<Long, EnergyMachineManager.Interaction>> filter) {
            throw new UnsupportedOperationException("Machine interaction view is read-only");
        }
