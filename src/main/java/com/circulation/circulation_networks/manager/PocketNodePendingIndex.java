...
final class PocketNodePendingIndex {
    ...
    private final Int2ObjectMap<Long2ObjectMap<PocketNodeRecord>> records = new Int2ObjectOpenHashMap<>();
    private final Int2ObjectMap<Long2ObjectMap<LongSet>> chunks = new Int2ObjectOpenHashMap<>();
    ...
    void put(PocketNodeRecord record) {
        ...
        long position = record.pos().toLong();
        //~}
        ...
        long chunk = ChunkCoordUtils.mergeChunkCoords(record.pos());
    ...
    @Nullable
    PocketNodeRecord get(int dimensionId, long position) {
    ...
    void retryChunk(int dimensionId, long chunk, ActivationAttempt activation) {
        Objects.requireNonNull(activation, "activation");
