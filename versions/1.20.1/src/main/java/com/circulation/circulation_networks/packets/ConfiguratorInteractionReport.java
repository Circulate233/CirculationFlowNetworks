...
public final class ConfiguratorInteractionReport implements Packet<ConfiguratorInteractionReport> {
    ...
    @Override
    public ConfiguratorInteractionReport decode(FriendlyByteBuf buf) {
    ...
    @Override
    public void handle(ConfiguratorInteractionReport message,
    ...
    private static long[] readPositions(FriendlyByteBuf buf) {
    ...
    private static String[] readValues(FriendlyByteBuf buf, int count) {
    ...
    private static void writeRanking(FriendlyByteBuf buf, long[] positions,
